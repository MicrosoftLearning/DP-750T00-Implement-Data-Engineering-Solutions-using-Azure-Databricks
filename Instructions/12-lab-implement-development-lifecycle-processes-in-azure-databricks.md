...
You are expected and **encouraged** to use the **Databricks Assistant** for every exercise. Open it via the chat icon in the top-right corner of the notebook editor, or click the **Assistant** button in the sidebar.
...
5. Choose **File**, browse to `DP-750/Allfiles/12-implement-development-lifecycle-processes-in-azure-databricks.ipynb`, and click **Import**.
